...
In this work, we therefore combine astrometry from \gaia\ with previously
measured line-of-sight velocities to study the 3D kinematics of giant stars
associated with the TriAnd and A13 structures.
If confirmed, this .. exciting prospect because they trace ... Galactoseismology
...

Inner disk signatures \citep{Widro:2012, Antoja:2018, Laporte:2018b}

Models for all structures .. reconstruct history of interaction and dark matter properties around disk...

A way to identify recently destroyed or undiscovered satellites \citep{Chakrabarti:2009}
